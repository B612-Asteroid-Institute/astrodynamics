...
public class OpmSerializationTest {
  ...
  @Test
  public void testToCcsdsOpmWithKeplerianMeanAnomalyAndCovariance() throws OdmParseException {
    String expectedString = "CCSDS_OPM_VERS = 2.0\n" +
        "CREATION_DATE = 2000-06-03T05:33:00.000\n" +
        "ORIGINATOR = GSOC\n" +
        "OBJECT_NAME = EUTELSAT W4\n" +
  ...
  @Test
  public void testToCcsdsOpmWithKeplerianTrueAnomalyAndCovariance() throws OdmParseException {
    String expectedString = "CCSDS_OPM_VERS = 2.0\n" +
        "CREATION_DATE = 2000-06-03T05:33:00.000\n" +
        "ORIGINATOR = GSOC\n" +
        "OBJECT_NAME = EUTELSAT W4\n" +
  ...
  private void testCcsdsSerialization(String expectedString) throws OdmParseException {
