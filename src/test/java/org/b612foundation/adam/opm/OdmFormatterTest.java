...
public class OdmFormatterTest {
  ...
  public void testBasicOorbOemHappy() throws OdmParseException {
    ...
    OrbitEphemerisMessage oemFromOorb = OdmFormatter.parseOorbEphemerisString(oorbEphemerisString, objectName, objectId);
    ...
    assertEquals(OdmCommonMetadata.ReferenceFrame.EME2000, metadata.getRef_frame());
