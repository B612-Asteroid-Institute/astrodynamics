...
/**
 * Orbit Ephemeris Message, or OEM, one of the three high-level message types defined in CCSDS ODM
...
public class OrbitEphemerisMessage implements Serializable {
  ...
  /**
   * One OEM message can contain several ephemerides, each with its own metadata block and optional
   * covariance.
   */
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(ccsdsOemVers, other.ccsdsOemVers)
