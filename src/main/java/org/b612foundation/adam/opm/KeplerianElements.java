...
/**
 * Osculating Keplerian Elements in the specified reference frame (none or all
 * parameters of this block must be given.)
 * 
...
public class KeplerianElements implements Serializable {
	...
	/*
	 * In TLE-based OMM mean_motion is used instead of semi_major_axis. Have
	 * separate fields here to keep things simpler.
	 */
	/** Semi-major axis, km */
	...
	/**
	 * Technically, it's true anomaly OR mean anomaly, but have separate fields to
	 * keep things simpler.
	 */
