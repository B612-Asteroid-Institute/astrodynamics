...
public class TargetedPropagation extends AdamObject {
   ...
   *
   * <p>The stopping time should be an estimate of the time of the perigee for which targeting
   * should be run.
   *
   * <p>The step size will be used for any generated ephemeris files.
   *
   * <p>The specified OPM may provide a maneuver, which will be used as the initial maneuver for
   * targeting. Currently only maneuvers of 0 seconds and 0 change in mass are supported. The only
   * reference frame currently supported is TNW, which is a local orbital coordinate frame that has
   * the x-axis along the velocity vector, W along the orbital angular momentum vector, and N
  ...
  /**
   * The resulting ephemeris from the targeter. This will be the nominal ephemeris if the targeter
   * is configured to propagate only the nominal trajectory, otherwise the targeted ephemeris.
   */
  private String ephemeris;

  /**
   * The calculated maneuver. Currently will only contain a modification from the initial maneuver
   * in the x-direction.
   */
  ...
  public TargetedPropagation setInitialPropagationParameters(
      PropagationParameters initialPropagationParameters) {
  ...
  public boolean equals(Object obj) {
    ...
    return super.equals(other)
        && Objects.equals(initialPropagationParameters, other.initialPropagationParameters)
        && Objects.equals(targetingParameters, other.targetingParameters)
        && Objects.equals(description, other.description)
        && Objects.equals(ephemeris, other.ephemeris)
        && Objects.equals(maneuverX, other.maneuverX)
        && Objects.equals(maneuverY, other.maneuverY)
