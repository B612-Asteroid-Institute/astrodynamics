...
public class ClasspathStreamFactory extends StreamFactory {
  ...
  public InputStream openStream() {
    // NOTE! Using getClassLoader().getResourceAsStream may be less safe than ClassLoader.getSystemResourceAsStream!
    // If running into strange issues loading files, try the other one! getClassLoader()... was added because of
