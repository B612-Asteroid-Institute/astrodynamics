...
public class TimeHelper {
   ...
   */
  public static JulianDate fromIsoFormat(String date, TimeStandard timeStandard) throws AdamRunnableException {
  ...
  /**
   * Formats the given date as a timestamp using the date's internal time standard (which will be whatever it is created
   * with).
   */
  public static String toIsoFormat(JulianDate date) {
    // Round to the nearest microsecond, since these are mainly used to hand back to the client and that's the precision
