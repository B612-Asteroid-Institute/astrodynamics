...
public class OorbMeasurementWriterTest {
  ...
  public void testLsstMeasurementConvert() throws IOException {
    var expectedLine =
        "5021 29824.5685211930 O 322.1144215759  -8.3891058546  22.3317800142 X I11   0.0010000000   0.0010000000  -1.0000000000  0.1000000E+01 X";
    ...
    var actual =
        new OorbMeasurementWriter(0.001, 0.001, -1.0)
            .convertWriteLsstToDesFormat(measurements.get(0));
  ...
  public void testLsstMeasurementsToDesFileWriter() throws IOException {
    var expectedLine =
        "5021 29824.5685211930 O 322.1144215759  -8.3891058546  22.3317800142 X I11   1.0000000000   1.0000000000   1.0000000000  0.1000000E+01 X";
    var csvFile = Paths.get("src/test/resources/single_object_lsst.csv");
    var measurements = LsstMeasurementReader.readSingleObjectCsvFile(csvFile, "I11  ");
    var tmpDesFile = Files.createTempFile("scratchObs", ".des");

    new OorbMeasurementWriter()
        .writeLsstMeasurementsToDesFile(tmpDesFile.toAbsolutePath(), measurements);
