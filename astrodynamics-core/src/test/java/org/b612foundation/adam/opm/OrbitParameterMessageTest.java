...
public class OrbitParameterMessageTest {
  ...
  public void sanityCheckEqualsAndHashcode() {
    ...
    OrbitParameterMessage opmKeplerianAndManeuvers =
        OdmScenarioBuilder.buildOpmWithKeplerianAndManeuvers();
    Assert.assertEquals(
        OdmScenarioBuilder.buildOpmWithKeplerianAndManeuvers(), opmKeplerianAndManeuvers);
    Assert.assertEquals(
        OdmScenarioBuilder.buildOpmWithKeplerianAndManeuvers().hashCode(),
    ...
    Assert.assertEquals(
        OdmScenarioBuilder.buildOpmWithCovariance("FACES").hashCode(),
        opmWithCovariance.hashCode());
