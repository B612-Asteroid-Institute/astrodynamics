...
public class PropagatorConfiguration extends AdamObject {
  ...
  /**
   * How to include gravity of individual bodies: ignore it all together, use it as point mass, or
   * use a detailed model. For now assume that there is only one "good" spherical harmonics model
   * for each body, so we don't specify which one to use.
   */
  ...
  public boolean equals(Object obj) {
    ...
    return super.equals(other)
        ...
        && Objects.equals(mercury, other.mercury)
        && Objects.equals(venus, other.venus)
        && Objects.equals(earth, other.earth)
        && Objects.equals(mars, other.mars)
        && Objects.equals(jupiter, other.jupiter)
        && Objects.equals(saturn, other.saturn)
        && Objects.equals(uranus, other.uranus)
        && Objects.equals(neptune, other.neptune)
        && Objects.equals(pluto, other.pluto)
        && Objects.equals(moon, other.moon)
