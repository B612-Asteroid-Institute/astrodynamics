...
/**
 * A request for propagation of one or more runs grouped together. Individual runs are generated
 * from this batch based on parameters specified using OPM extension tags.
 */
public class BatchRequest {
  ...
  /**
   * Unique id for a pending batch request, generated on creation. A single request can result in
   * multiple runs.
   */
  private String uuid;
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(uuid, other.uuid)
        && Objects.equals(calcState, other.calcState)
        && Objects.equals(description, other.description)
        && Objects.equals(end_time, other.end_time)
        && Objects.equals(error, other.error)
        && Objects.equals(opm_string, other.opm_string)
  ...
  public String toString() {
    return "BatchRequest [description="
        + description
        + ", start_time="
        + start_time
        + ", end_time="
