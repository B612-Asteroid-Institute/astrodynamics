...
public final class AstroUtils {
  ...
  /**
   * Given a date/time represented by a LocalDateTime object compute the equivalent Modified Julian
   * Date
   *
  ...
  /**
   * Given a date/time represented by a ZonedDateTime object compute the equivalent Modified Julian
   * Date
   *
   * @param dateTime date/time to be converted
   * @return Modified Julian Date of input date/time
