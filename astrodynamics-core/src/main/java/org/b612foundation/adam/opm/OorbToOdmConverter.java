...
public class OorbToOdmConverter {
  ...
  public static OrbitParameterMessage oorbFullOrbitToOpm(String orbitLine) {
    ...
    cartesianCovariance.setCx_dot_x(
        Double.parseDouble(elems[covXXdotIndex]) * posVelCovElemAstroToSI);
    cartesianCovariance.setCy_dot_x(
        Double.parseDouble(elems[covXYdotIndex]) * posVelCovElemAstroToSI);
    cartesianCovariance.setCz_dot_x(
        Double.parseDouble(elems[covXZdotIndex]) * posVelCovElemAstroToSI);

    cartesianCovariance.setCz_y(Double.parseDouble(elems[covYZIndex]) * posPosCovElemAstroToSI);
    cartesianCovariance.setCx_dot_y(
        Double.parseDouble(elems[covYXdotIndex]) * posVelCovElemAstroToSI);
    cartesianCovariance.setCy_dot_y(
        Double.parseDouble(elems[covYYdotIndex]) * posVelCovElemAstroToSI);
    cartesianCovariance.setCz_dot_y(
        Double.parseDouble(elems[covYZdotIndex]) * posVelCovElemAstroToSI);

    cartesianCovariance.setCx_dot_z(
        Double.parseDouble(elems[covZXdotIndex]) * posVelCovElemAstroToSI);
    cartesianCovariance.setCy_dot_z(
        Double.parseDouble(elems[covZYdotIndex]) * posVelCovElemAstroToSI);
    cartesianCovariance.setCz_dot_z(
        Double.parseDouble(elems[covZZdotIndex]) * posVelCovElemAstroToSI);
