...
public class TimeHelperTest {
  ...
  public void testTimeHelper() throws AdamRunnableException {
    ...
    Assert.assertEquals(
        date,
        TimeHelper.toIsoFormat(
            TimeHelper.fromIsoFormat(date, TimeStandard.getCoordinatedUniversalTime())));
    Assert.assertEquals(
        date,
        TimeHelper.toIsoFormat(
            TimeHelper.fromIsoFormat(date, TimeStandard.getInternationalAtomicTime())));
    Assert.assertEquals(
        date,
    ...
    Assert.assertEquals(
        noZ + 'Z',
        TimeHelper.toIsoFormat(
            TimeHelper.fromIsoFormat(noZ, TimeStandard.getCoordinatedUniversalTime())));
    ...
    // Check that a timestamp with more than microseconds precision gets cut off at microseconds
